...
class Bot:
    ...
    def save_q_matrix(self, end, total_learning_time, episodes, minutes_learning, total, minutes, distance, speed):
        try:
            #open correct file 
            ...
            #add statistics
            string += ("\nLearning time = " + str(total_learning_time) + " seconds = " \
                                       + str(minutes_learning) + " minutes")
            string += ("\nNumber Episodes = " + str(episodes))
            string += ("\nTotal time = " + str(total) + " seconds = " + str(minutes) + " minutes")
    ...
    #use pre defined q matrix to drive, to see whether driving works or not (not in use anymore)
